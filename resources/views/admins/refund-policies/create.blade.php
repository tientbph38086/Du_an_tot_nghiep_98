                                    ...
                                    <div class="lh-user-detail">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="form-group">
                                                    <input type="number" placeholder="Tỷ lệ hoàn tiền (%)" id="refund_percentage" name="refund_percentage" value="{{ old('refund_percentage') }}" min="0" max="100"
                                            ...
                                            <li>
                                                ...
                                                <div class="form-group">
                                                    <input type="number" placeholder="Số ngày trước check-in" id="days_before_checkin" name="days_before_checkin" value="{{ old('days_before_checkin') }}" min="0"
                                                        class="form-control" step="1">
