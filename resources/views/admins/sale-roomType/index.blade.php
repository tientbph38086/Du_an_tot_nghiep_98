                        ...
                        <div class="lh-card-header">
                            ...
                            <div class="header-tools">
                                ...
                                <button class="btn btn-primary ms-2"
                                    onclick="window.location.href='{{ route('admin.sale-room-types.create') }}'">
                                    Thêm mới
                                </button>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @foreach ($saleRoomTypes as $name => $saleRoomTypeGroup)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $name }}
                                                        ({{ $saleRoomTypeGroup->first()->value }}{{ $saleRoomTypeGroup->first()->type == 'percent' ? '%' : 'VND' }})
                                                    </td>
                                                    <td>{{ \App\Helpers\FormatHelper::formatDate($saleRoomTypeGroup->first()->created_at) }}
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="text-{{ $saleRoomTypeGroup->first()->status === 'active' ? 'success' : 'danger' }}">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.sale-room-types.edit', $saleRoomTypeGroup->first()) }}">
                                                                        <i class="ri-edit-line"></i> Sửa
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.sale-room-types.show', $saleRoomTypeGroup->first()->id) }}">
