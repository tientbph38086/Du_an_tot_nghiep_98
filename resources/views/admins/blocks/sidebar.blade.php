...
<div class="lh-sidebar" data-mode="light">
    <div class="lh-sb-logo">
        <a href="{{ route('admin.dashboard') }}" class="sb-full">
            <img src="{{ asset('assets/admin/assets/img/logo/full.png') }}" alt="logo">
        </a>
        <a href="{{ route('admin.dashboard') }}" class="sb-collapse">
            <img src="{{ asset('assets/admin/assets/img/logo/logo_admin.png') }}" alt="logo">
        </a>
    </div>
    <div class="lh-sb-wrapper">
        <div class="lh-sb-content">
            <ul class="lh-sb-list">
                ...
                @canany(['customers_list', 'staffs_list', 'roles_list'])
                    <li class="lh-sb-item sb-drop-item">
                        ...
                        <ul class="lh-sb-drop condense">
                            @can('customers_list')
                                <li><a href="{{ route('admin.customers.index') }}" class="lh-page-link drop"><i
                                            class="ri-git-commit-line"></i>Danh sách khách hàng</a></li>
                            @endcan
                            @can('staffs_list')
                ...
                @canany(['staffs_list', 'staffs_create', 'staffs_trashed', 'staff_roles_list', 'staff_roles_create',
                    'staff_shifts_list', 'staff_shifts_create'])
                    {{--                <li class="lh-sb-item sb-drop-item"> --}}
                    {{--                    <a href="javascript:void(0)" class="lh-drop-toggle"> --}}
